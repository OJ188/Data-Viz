...
#Comparison of weed transaction prices in the US in 2014-2015
...
Maybe the query form is not intuitive enough ? So let's take a look at a lollipop chart !
...
Well, we all know that the legal restrictions on cannabis have gradually been relaxed after 2014, so can we conclude that the trend of prices reflects the previous conjecture of impact factors?(Take Washington as an example)
...
#Comparison of different quality prices of cannabis in different states（high, medium and low quality).
